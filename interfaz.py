...
nombretarj_credito_cph=Label(ventana, text="Tasa llegada clientes para Tarjetas Credito:", font=("Arial bold", 13), background=back)
...
nombrecaja_cph=Label(ventana, text="Tasa llegada clientes para Caja:", font=("Arial bold", 13), background=back)
...
nombreat_personalizada_cph=Label(ventana, text="Tasa llegada clientes para Atencion Personalizada:", font=("Arial bold", 13), background=back)
...
nombreplazo_fijo_cph=Label(ventana, text="Tasa llegada clientes para Plazo Fijo:", font=("Arial bold", 13), background=back)
...
nombreprestamos_cph=Label(ventana, text="Tasa llegada clientes para Prestamos:", font=("Arial bold", 13), background=back)
...
nombrecantidad_cajeros_cph=Label(ventana, text="Cantidad de cajeros atendiendo:", font=("Arial bold", 13), background=back)
...
nombretiempo_simulacion=Label(ventana, text="Duracion de la simulacion:", font=("Arial bold", 13), background=back)
...
nombrecantidad_lineas_a_mostrar=Label(ventana, text="Cantidad de lineas a mostrar:", font=("Arial bold", 13), background=back)
